...
for agenku in range(10000):
	...
	c='Redmi Note 9 Pro Max Build/RKQ1.200826.002; wv)'
	d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.105'
	e=random.randrange(73,100)
	f='0'
	g=random.randrange(4200,4900)
	h=random.randrange(40,150)
	i='Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/392.2.0.33.108;]'
	uakuh=f'{a} {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
	usragent.append(uakuh)
	
	a='Mozilla/5.0 (Linux; Android 8.1.0;'
	b=random.choice(['8.1.0','9','10','11','12','13'])
	c='SM-G610F Build/M1AJQ; wv)'
	d='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128'
	e=random.randrange(73,100)
	f='0'
	g=random.randrange(4200,4900)
	h=random.randrange(40,150)
...
def banner():
	os.system('clear')
	baz_bann(f'''{biru}  welcome to my sc gunakan dengan bijak 
{hijo} _    __   ____   _   __   _____
{hijo}| |  / /  /  _/  / | / /  /__  /
{hijo}| | / /   / /   /  |/ /     / / 
{hijo}| |/ /  _/ /   / /|  /     / /__
{hijo}|___/  /___/ _/_/_|_/__   /____/    
V I N Z X D''')
...
def atur_dulu():
	...
	if aturid in ['1','01']:
		...
		baz_anim(f'{mer}└── yang bener lah kon')
		exit()
